...
"""
    ...
    elif study_set_name == 'HYBRID_JANELIA':
        hybrid_janelia_experiment_description = """# Hybrid janelia
...
"""
        study_info = StudyInfo(
            ...
            experiment_description=hybrid_janelia_experiment_description,
            lab='Janelia Research Campus',
            institution='Janelia Research Campus',
            keywords=['ground truth', 'simulation'],
            subject=Subject(
                subject_id='hybrid_janelia',
                age='P0Y',
                date_of_birth=datetime(1970, 1, 1, tzinfo=tzlocal()),
                sex='U',
                species='Mus musculus',
...
def _get_recording_info(R: SFRecording):
    ...
    elif R.study_set_name == 'HYBRID_JANELIA':
        recording_info = RecordingInfo(
            device_name='Simulation',
            device_description='Simulation'
        )
    else:
