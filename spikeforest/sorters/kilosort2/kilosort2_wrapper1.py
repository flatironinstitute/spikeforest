...
def get_image(**kwargs):
    ...
    hither_matlab_mlm_license_file = os.getenv('HITHER_MATLAB_NLM_LICENSE_FILE', None)
    if hither_matlab_lnu_credentials_path:
        ...
        raise Exception('No matlab license specified. Set one of the following environment variables: HITHER_MATLAB_NLM_LICENSE_FILE or HITHER_MATLAB_LNU_CREDENTIALS_PATH.')
    #################################################
